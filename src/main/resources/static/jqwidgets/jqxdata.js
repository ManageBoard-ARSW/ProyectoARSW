                    ...
                    if (W._localdata) {
                        ...
                        if (aa == "add") {
                            ...
                            for (var Z = 0; Z < M; Z++) {
                                ...
                                if (!L) {
                                    ah._changedrecords.push({index: Z, oldrecord: null, record: I, position: (Z != 0 ? "last" : "first")})
                                }
                            }
                        } else {
                            if (aa == "remove") {
                ...
                case"ics":
                    ...
                    if (W.url && W.url.length > 0) {
                        if (i.isFunction(K.loadServerData)) {
                            ...
                            this.xhr = i.jqx.data.ajax({dataType: X, cache: this.cache, type: J, url: W.url, async: N, timeout: W.timeout, contentType: ab, data: af, success: function (am, aj, ap) {
                                    if (i.isFunction(W.beforeprocessing)) {
